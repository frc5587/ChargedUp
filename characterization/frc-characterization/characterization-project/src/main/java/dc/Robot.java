...
public class Robot extends TimedRobot {
  ...
  static private double GEARING = 8.14;
  ...
  DifferentialDrive drive;
    ...
    WPI_TalonFX m1a = new WPI_TalonFX(15);
    WPI_TalonFX m2a = new WPI_TalonFX(16);
    WPI_TalonFX m3a = new WPI_TalonFX(17);
    WPI_TalonFX m4a = new WPI_TalonFX(18);

    WPI_TalonFX[] anglemotors = {m1a, m2a, m3a, m4a};
  ...
  public void robotInit() {
    ...
    // create left motor
    WPI_TalonFX leftMotor = setupWPI_TalonFX(10, Sides.LEFT, false);

    WPI_TalonFX leftFollowerID11 = setupWPI_TalonFX(11, Sides.FOLLOWER, false);
    leftFollowerID11.follow(leftMotor);

    WPI_TalonFX rightMotor = setupWPI_TalonFX(12, Sides.RIGHT, false);
    WPI_TalonFX rightFollowerID13 = setupWPI_TalonFX(13, Sides.FOLLOWER, false);  

    rightFollowerID13.follow(rightMotor);
    for(WPI_TalonFX motor : anglemotors) {
        motor.configFactoryDefault();
