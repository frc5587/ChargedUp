...
public class SwerveSim extends SubsystemBase {
    ...
    private final SwerveModuleSim[] moduleIOs = new SwerveModuleSim[4]; // FL, FR, BL, BR
    ...
    /** Creates a new Drive. */
    public SwerveSim(GyroSim gyroSim, SwerveModuleSim flModuleIO, SwerveModuleSim frModuleIO,
            SwerveModuleSim blModuleIO, SwerveModuleSim brModuleIO) {
        ...
        maxLinearSpeed = SwerveConstants.MAX_SPEED;
