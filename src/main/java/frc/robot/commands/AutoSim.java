...
public class AutoSim {
    ...
    public AutoSim(Intake intake, Arm arm, SwerveSim swerve, LEDs leds) {
        ...
        this.c_pos2Spit = new ParallelCommandGroup(
                new InstantCommand(() -> swerve.setPose(DriverStation.getAlliance() == Alliance.Blue
        ...
        SmartDashboard.putData("Sim Path", autoChooser);
